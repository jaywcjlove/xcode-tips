...
你可以使用快捷键 <kbd>Control</kbd> + <kbd>⌘</kbd> + <kbd>t</kbd> 来创建右侧的编辑器窗格；也可以按住 <kbd>Shift</kbd> + <kbd>Option</kbd>，然后点击文件导航中的文件，将其直接在右侧编辑器窗格中打开。

https://github.com/user-attachments/assets/1c5e07af-68ce-4145-bf0f-c52869bbdf84?title=右侧编辑器窗格&rehype=video