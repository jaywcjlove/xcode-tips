...
You can use the shortcut <kbd>Control</kbd> + <kbd>⌘</kbd> + <kbd>t</kbd> to create a right editor pane; alternatively, hold <kbd>Shift</kbd> + <kbd>Option</kbd> and click a file in the file navigator to open it directly in the right editor pane.

https://github.com/user-attachments/assets/1c5e07af-68ce-4145-bf0f-c52869bbdf84?title=Right%20Editor%20Pane&rehype=video